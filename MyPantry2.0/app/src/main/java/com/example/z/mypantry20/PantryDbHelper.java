...
public class PantryDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_RECIPE =
            "CREATE TABLE IF NOT EXISTS " + PantryContract.Recipe.TABLE_NAME + " (" +
                    PantryContract.Recipe._ID + " INTEGER PRIMARY KEY," +
                    PantryContract.Recipe.PANTRY_ITEM_ID + " INTEGER " + COMMA_SEP +
                    PantryContract.Recipe.AMOUNT + " VARCHAR(100)) ";
    ...
    private static final String SQL_DELETE_RECIPE =
            "DROP TABLE IF EXISTS " + PantryContract.Recipe.TABLE_NAME;
